...
export const ru = {
    ...
    "meta.nameLatin": "Идентификатор — латиница, цифры и подчёркивание, но начинается с буквы",
    ...
    "check.nameLatin": "Идентификатор начинается с буквы, дальше латиница, цифры и _",
